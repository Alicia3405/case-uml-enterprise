      ...
      nodes: [
        {
          ...
          data: {
            ...
            estado: 'PENDIENTE',
            count: pendCount,
            color: ESTADO_VISUAL_CONFIG['PENDIENTE']?.color || '#64748b',
        ...
        },
        {
          ...
          data: {
            ...
            estado: 'EN_REVISION',
            count: revCount,
            color: ESTADO_VISUAL_CONFIG['EN_REVISION']?.color || '#2563eb',
        ...
        },
        {
          ...
          data: {
            ...
            estado: 'APROBADO',
            count: appCount,
            color: ESTADO_VISUAL_CONFIG['APROBADO']?.color || '#16a34a',
        ...
        },
        {
          ...
          data: {
            ...
            estado: 'RECHAZADO',
            count: rejCount,
            color: ESTADO_VISUAL_CONFIG['RECHAZADO']?.color || '#dc2626',
