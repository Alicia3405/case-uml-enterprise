...
export class DocumentoService {
  ...
  crearDocumentoColaborativo(solicitudId: string, nombre: string, descripcion: string, contenido: string = ''): Observable<Documento> {
    return this.http
      .post<ApiResponse<Documento>>(`${this.basePath}/api/v1/documentos/solicitud/${solicitudId}/colaborativo`, null, {
        params: { nombre, descripcion, contenido },
        headers: this.getHeaders()
      })
      .pipe(map(res => {
