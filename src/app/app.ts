...
export class App implements OnDestroy {
  ...
  private static readonly CHAT_WIDGET_HIDDEN_ROUTES = ['/mapa-avanzado', '/asistente', '/documentos/editar', '/uml-workspace', '/'];
  ...
  isStandaloneRoute = computed(() => {
    ...
    return url.startsWith('/bpmn-workspace') || url.startsWith('/documentos/editar') || url.startsWith('/uml-workspace') || url === '/';
  });
